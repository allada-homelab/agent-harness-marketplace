---
name: feature-dev
description: A comprehensive, structured 7-phase workflow for building new features that explores the codebase, asks clarifying questions, designs architecture, implements, reviews for quality, and summarizes — driven by specialized code-explorer, code-architect, and code-reviewer agents.
harness:
- claude
---
