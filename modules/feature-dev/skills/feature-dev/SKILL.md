---
name: feature-dev
description: Guided seven-phase feature development with codebase understanding and architecture focus. Use when a user asks to build, add or implement a feature that touches more than one file, or wants a systematic approach before coding; also invoked as /feature-dev [feature description].
user-invocable: true
argument-hint: Optional feature description
license: Apache-2.0
metadata:
  upstream: anthropics/claude-plugins-official feature-dev (commit 76b35e9), ported harness-neutral
---
...
- **Track progress**: Keep a todo list of the phases (the harness's todo tool where it has one, otherwise a checklist you update in your replies)
